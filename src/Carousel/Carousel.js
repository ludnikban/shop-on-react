...
import logo from '../img/icon-3.png';
          ...
          <div className="container">
            ...
            <nav className="navbar navbar-expand-lg navbar-light">
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <button className="btn btn-outline-success my-2 my-sm-0 page-header__cart-btn"
                        type="submit">
                  <i className="fas fa-shopping-cart" aria-hidden="true"></i>
                  <span id="cart-counter" className="page-header__cart-counter">4</span>
                </button>
              </div>
